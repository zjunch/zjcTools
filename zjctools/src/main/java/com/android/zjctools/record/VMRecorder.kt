...
import com.android.zjctools.utils.ZFile.deleteFile
import com.android.zjctools.utils.ZFile.isFileExists
import com.android.zjctools.utils.ZFile.music
 ...
 */
 object VMRecorder{
    ...
    // 音频采样率 单位 Hz
    var mSamplingRate = 8000

    // 音频编码比特率
    var mEncodingBitRate = 64

    // 录音最大持续时间 10 分钟
    var mMaxDuration = 10 * 60 * 1000

    // 计算分贝基准值
    var mDecibelBase = 200
    ...
    fun startRecord(path: String?): Int {
        ...
        if (isEmpty(path)) {
            ...
            recordFile = music + "VMVoice_" + ZDate.filenameDateTime() + ".amr"
        } else {
