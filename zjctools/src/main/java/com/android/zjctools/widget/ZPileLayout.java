 ...
 * app:PileLayout_pileWidth="16dp" />   此处16dp是重叠宽度
 */
public class ZPileLayout extends ViewGroup {
    ...
    public ZPileLayout(Context context) {
        this(context, null, 0);
    }

    public ZPileLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZPileLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ZPileLayout);
        vertivalSpace = ta.getDimension(R.styleable.ZPileLayout_zv_pileLayout_verSpace, dp2px(4));
        pileWidth = ta.getDimension(R.styleable.ZPileLayout_zv_pileLayout_pileWidth, dp2px(10));
        ta.recycle();
    }
