...
import kotlinx.android.synthetic.main.z_widget_common_picker_area.view.*
 ...
 * 地区选择器
 */
class ZAreaPicker @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : LinearLayout(context, attrs, defStyleAttr) {

    private var mProvinceList: MutableList<Province> = mutableListOf()
    private var mCityList: MutableList<City> = mutableListOf()

    init {
        LayoutInflater.from(context).inflate(R.layout.z_widget_common_picker_area, this)
