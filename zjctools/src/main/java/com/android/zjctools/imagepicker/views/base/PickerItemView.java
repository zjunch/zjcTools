...
public abstract class PickerItemView extends PBaseLayout {
     ...
     * @param presenter    implements of {@link com.android.zjctools.imagepicker.presenter.IPickerPresenter}
     * @return 拍照
     */
     ...
     *
     * @param imageItem   当前图片
     * @param disableCode 不能选中的原因 {@link com.android.zjctools.imagepicker.bean.PickerItemDisableCode}
     */
